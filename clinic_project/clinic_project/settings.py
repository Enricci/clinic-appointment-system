...
SECRET_KEY = 'django-insecure-@7by=guwk^1)mm^7ek4_s+l#*&nh_ua3&dv&q_sg+zq2&e!jz*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'clinic_project' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                ...
                'clinic_app.context_processors.user_type',
            ],
        },
    },
]
